...
INTERFACEVIEW=data_log_replay_ut_iv.aadl
grep "version => \"2" data_log_replay_ut_iv.aadl >/dev/null && {
    echo -e "${INFO} Converting interface view from V2 to V1.3"
    TASTE --load-interface-view data_log_replay_ut_iv.aadl --export-interface-view-to-1_3 __iv_1_3.aadl
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	--subCPP rbs_replay:/home/taste/esrocos_workspace/install/share/taste_components/data_loggers/rbs_replay.zip \
	--subCPP double_replay:/home/taste/esrocos_workspace/install/share/taste_components/data_loggers/double_replay.zip \
	--subCPP motion_command2d_replay:/home/taste/esrocos_workspace/install/share/taste_components/data_loggers/motion_command2d_replay.zip \
